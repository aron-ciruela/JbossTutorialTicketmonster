...
import org.jboss.tools.examples.model.Ticket;
import org.jboss.tools.examples.model.TicketCategory;
import org.jboss.tools.examples.model.TicketPrice;
import org.jboss.tools.examples.rest.qualifier.Cancelled;
import org.jboss.tools.examples.rest.qualifier.Created;
import org.jboss.tools.examples.service.AllocatedSeats;
    ...
    public Response createBooking(BookingRequest bookingRequest) {
        try {
            ...
            Map<Section, AllocatedSeats> seatsPerSection =
			       new TreeMap<Section, org.jboss.tools.examples.service.AllocatedSeats>(SectionComparator.instance());
